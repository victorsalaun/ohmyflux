...
func GetConfigMaps(kubernetesClient *kubernetes.Clientset, namespace string, label string) (*v1.ConfigMapList, error) {
...
func GetDeployments(kubernetesClient *kubernetes.Clientset, namespace string, label string) (*v1beta.DeploymentList, error) {
	return kubernetesClient.ExtensionsV1beta1().Deployments(namespace).List(context.TODO(), metav1.ListOptions{
		LabelSelector: LabelSelectorKey + label,
	})
}

func GetEndpoints(kubernetesClient *kubernetes.Clientset, namespace string, label string) (*v1.EndpointsList, error) {
...
func GetPods(kubernetesClient *kubernetes.Clientset, namespace string, label string) (*v1.PodList, error) {
	return kubernetesClient.CoreV1().Pods(namespace).List(context.TODO(), metav1.ListOptions{
		LabelSelector: LabelSelectorKey + label,
	})
}

func GetSecrets(kubernetesClient *kubernetes.Clientset, namespace string, label string) (*v1.SecretList, error) {
	return kubernetesClient.CoreV1().Secrets(namespace).List(context.TODO(), metav1.ListOptions{
		LabelSelector: LabelSelectorKey + label,
	})
}

func GetServiceAccounts(kubernetesClient *kubernetes.Clientset, namespace string, label string) (*v1.ServiceAccountList, error) {
	return kubernetesClient.CoreV1().ServiceAccounts(namespace).List(context.TODO(), metav1.ListOptions{
		LabelSelector: LabelSelectorKey + label,
	})
}

func GetServices(kubernetesClient *kubernetes.Clientset, namespace string, label string) (*v1.ServiceList, error) {
