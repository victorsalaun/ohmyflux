...
import (
	...
	"github.com/victorsalaun/ohmyflux/pkg/text"
	"io"
	"sort"
	"strings"
...
func rootUsageFunc(w io.Writer, command *cobra.Command) error {
	...
	if flagUsages != "" {
		_, _ = fmt.Fprintln(w, "\n\nFlags:")
		_, _ = fmt.Fprint(w, text.Indent(dedent(flagUsages), "  "))
	}
	return nil
}
...
Use 'ohmyflux <command> <subcommand> --help' for more information about a command.`})
